...
module top ;
	...
	wire [0:0] tmpOE__Pin_debug_net;
	wire [0:0] tmpFB_0__Pin_debug_net;
	wire [0:0] tmpIO_0__Pin_debug_net;
	wire [0:0] tmpINTERRUPT_0__Pin_debug_net;
	electrical [0:0] tmpSIOVREF__Pin_debug_net;

	cy_psoc3_pins_v1_10
		#(.id("6c935a40-edd8-47ad-81fc-14aeffd067c7"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_debug
		 (.oe(tmpOE__Pin_debug_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_debug_net[0:0]}),
		  .io({tmpIO_0__Pin_debug_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_debug_net),
		  .interrupt({tmpINTERRUPT_0__Pin_debug_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_debug_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_count_10_net;
	wire [0:0] tmpFB_0__Pin_count_10_net;
	wire [0:0] tmpIO_0__Pin_count_10_net;
	wire [0:0] tmpINTERRUPT_0__Pin_count_10_net;
	electrical [0:0] tmpSIOVREF__Pin_count_10_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7a801abf-7478-41b1-9f25-a3cc9c5bd216"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_count_10
		 (.oe(tmpOE__Pin_count_10_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_count_10_net[0:0]}),
		  .io({tmpIO_0__Pin_count_10_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_count_10_net),
		  .interrupt({tmpINTERRUPT_0__Pin_count_10_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_count_10_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_count_20_net;
	wire [0:0] tmpFB_0__Pin_count_20_net;
	wire [0:0] tmpIO_0__Pin_count_20_net;
	wire [0:0] tmpINTERRUPT_0__Pin_count_20_net;
	electrical [0:0] tmpSIOVREF__Pin_count_20_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("283096ce-e9f2-48b4-97f3-91ccafb1b3c5"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_count_20
		 (.oe(tmpOE__Pin_count_20_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_count_20_net[0:0]}),
		  .io({tmpIO_0__Pin_count_20_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_count_20_net),
		  .interrupt({tmpINTERRUPT_0__Pin_count_20_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_count_20_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_count_neg_10_net;
	wire [0:0] tmpFB_0__Pin_count_neg_10_net;
	wire [0:0] tmpIO_0__Pin_count_neg_10_net;
	wire [0:0] tmpINTERRUPT_0__Pin_count_neg_10_net;
	electrical [0:0] tmpSIOVREF__Pin_count_neg_10_net;

	cy_psoc3_pins_v1_10
		#(.id("f5b8d6d8-5c2c-4d3a-b6b3-f323b2d95168"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_count_neg_10
		 (.oe(tmpOE__Pin_count_neg_10_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_count_neg_10_net[0:0]}),
		  .io({tmpIO_0__Pin_count_neg_10_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_count_neg_10_net),
		  .interrupt({tmpINTERRUPT_0__Pin_count_neg_10_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_count_neg_10_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_count_neg_20_net;
	wire [0:0] tmpFB_0__Pin_count_neg_20_net;
	wire [0:0] tmpIO_0__Pin_count_neg_20_net;
	wire [0:0] tmpINTERRUPT_0__Pin_count_neg_20_net;
	electrical [0:0] tmpSIOVREF__Pin_count_neg_20_net;

	cy_psoc3_pins_v1_10
		#(.id("fc2db3e4-0677-4f0d-9737-7ba9a2b60a3c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_count_neg_20
		 (.oe(tmpOE__Pin_count_neg_20_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_count_neg_20_net[0:0]}),
		  .io({tmpIO_0__Pin_count_neg_20_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_count_neg_20_net),
		  .interrupt({tmpINTERRUPT_0__Pin_count_neg_20_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_count_neg_20_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_267[0] = ~Net_200;

	wire [0:0] tmpOE__Pin_manual_1_net;
	wire [0:0] tmpIO_0__Pin_manual_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_manual_1_net;
	electrical [0:0] tmpSIOVREF__Pin_manual_1_net;

	cy_psoc3_pins_v1_10
		#(.id("01c752fd-77ed-462a-b3e1-a2af8b7bcee2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_manual_1
		 (.oe(tmpOE__Pin_manual_1_net),
		  .y({1'b0}),
		  .fb({Net_313}),
		  .io({tmpIO_0__Pin_manual_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_manual_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_manual_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_manual_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_267[1] = ~Net_223;

	wire [0:0] tmpOE__Pin_Manual_2_net;
	wire [0:0] tmpIO_0__Pin_Manual_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Manual_2_net;
	electrical [0:0] tmpSIOVREF__Pin_Manual_2_net;

	cy_psoc3_pins_v1_10
		#(.id("4ce312fd-9104-400b-8807-23b68d7cfa69"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Manual_2
		 (.oe(tmpOE__Pin_Manual_2_net),
		  .y({1'b0}),
		  .fb({Net_312}),
		  .io({tmpIO_0__Pin_Manual_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Manual_2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Manual_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Manual_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_309[0] = ~Net_313;


    assign Net_309[1] = ~Net_312;
    ...
    defparam Debouncer_2.SignalWidth = 2;

    CyStatusReg_v1_90 Status_Reg_Manual (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_293),
        .status_bus(Net_295[1:0]));
    defparam Status_Reg_Manual.Bit0Mode = 0;
    defparam Status_Reg_Manual.Bit1Mode = 0;
    defparam Status_Reg_Manual.Bit2Mode = 0;
    defparam Status_Reg_Manual.Bit3Mode = 0;
    defparam Status_Reg_Manual.Bit4Mode = 0;
    defparam Status_Reg_Manual.Bit5Mode = 0;
    defparam Status_Reg_Manual.Bit6Mode = 0;
    defparam Status_Reg_Manual.Bit7Mode = 0;
    defparam Status_Reg_Manual.BusDisplay = 1;
    defparam Status_Reg_Manual.Interrupt = 1;
    defparam Status_Reg_Manual.MaskValue = 3;
    defparam Status_Reg_Manual.NumInputs = 2;
