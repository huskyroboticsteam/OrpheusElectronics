    ...
    *******************************************************************************/
    uint8 CAN_SendMsgTest(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_Test_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_Test_CALLBACK
                    CAN_SendMsg_Test_Callback();
                #endif /* CAN_SEND_MSG_Test_CALLBACK */
