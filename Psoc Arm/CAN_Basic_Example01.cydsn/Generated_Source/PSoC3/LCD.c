...
static void LCD_WrDatNib(uint8 nibble) CYREENTRANT;
static void LCD_WrCntrlNib(uint8 nibble) CYREENTRANT;
...
*
*******************************************************************************/
void LCD_Position(uint8 row, uint8 column) CYREENTRANT
{
    switch (row)
    {
        case (uint8)0:
...
*
*******************************************************************************/
void LCD_PrintString(char8 const string[]) CYREENTRANT
{
    uint8 indexU8 = 1u;
...
*
*******************************************************************************/
void LCD_PutChar(char8 character) CYREENTRANT
{
...
*
*******************************************************************************/
void LCD_WriteData(uint8 dByte) CYREENTRANT
{
    uint8 nibble;
...
*
*******************************************************************************/
void LCD_WriteControl(uint8 cByte) CYREENTRANT
{
    uint8 nibble;
...
*
*******************************************************************************/
void LCD_IsReady(void) CYREENTRANT
{
    uint8 value;
    uint32 timeout;
...
static void LCD_WrCntrlNib(uint8 nibble) CYREENTRANT
{
    ...
    *
    *******************************************************************************/
    void LCD_PrintInt8(uint8 value) CYREENTRANT
    {
