...
module QuadDec_v3_0_2 (
    ...
    defparam bQuadDec.UsingIndexInput = 1;
...
module ADC_SAR_SEQ_P4_v2_50_3 (
	...
	cy_psoc3_pins_v1_10
		#(.id("ffc0bb23-7edf-4fb4-b366-37cbfaf613db/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("ffc0bb23-7edf-4fb4-b366-37cbfaf613db/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// CAN_v3_0(AckError=false, AckErrorUseHelper=true, AdvancedInterruptConfig=true, APIDictionary=0, Arbiter=0, ArbLost=false, ArbLostUseHelper=true, BaudRate=125, BitError=false, BitErrorUseHelper=true, Bitrate=19, BussOff=false, BussOffUseHelper=true, ClkFrequency=40, ConnectExtInterruptLine=false, ConnectTxEn=false, CrcError=false, CrcErrorUseHelper=true, DataGridSaved=0, EdgeMode=0, FormError=false, FormErrorUseHelper=true, FullCustomIntISR=true, IntEnable=true, IntISRDisable=false, M0S8CAN_BLOCK_VER=1, Overload=false, OverloadUseHelper=true, Reset=1, RTRAutomaticReply=false, RTRAutomaticReplyUseHelper=true, RxMsg=true, RxMsgLost=false, RxMsgLostUseHelper=true, RxMsgUseHelper=false, Sjw=2, Sm=0, SSTError=false, SSTErrorUseHelper=true, StuckAtZero=false, StuckAtZeroUseHelper=true, StuffError=false, StuffErrorUseHelper=true, SwapDataByteEndianness=false, Tseg1=13, Tseg2=2, TxMsg=false, TxMsgUseHelper=true, XMLMainData=<?xml version="1.0" encoding="utf-16"?><CyParameters xmlns:version="v1.50"><TXRegUnits><CyRegUnit Type="etTX" Name="0" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etTX" Name="1" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etTX" Name="2" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etTX" Name="3" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etTX" Name="4" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etTX" Name="5" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etTX" Name="6" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etTX" Name="7" State="esBasic" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /></TXRegUnits><RXRegUnits><CyRegUnit Type="etRX" Name="ToBaseRotation_1" State="esFull" Id="1104" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToShoulder_1" State="esFull" Id="1105" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToElbow_1" State="esFull" Id="1106" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ForearmRot_1" State="esFull" Id="1107" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToDiffWrist_1" State="esFull" Id="1108" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToDiffWrist2_1" State="esFull" Id="1109" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToHand_1" State="esFull" Id="1110" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToBaseRotation_0" State="esFull" Id="80" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToShoulder_0" State="esFull" Id="81" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToElbow_0" State="esFull" Id="82" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ForearmRot_0" State="esFull" Id="83" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToDiffWrist_0" State="esFull" Id="84" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToDiffWrist2_0" State="esFull" Id="85" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="ToHand_0" State="esFull" Id="86" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="true" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="14" State="esEmpty" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /><CyRegUnit Type="etRX" Name="15" State="esEmpty" Id="0" IDE="false" RTR="false" RTRReply="false" DLC="8" IRQ="false" Linking="false" SST="false" /></RXRegUnits></CyParameters>, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CAN_v3_0, CY_CONFIG_TITLE=CAN, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CAN, CY_INSTANCE_SHORT_NAME=CAN, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CAN, )
module CAN_v3_0_4 (
    rx,
    tx,
    tx_en,
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=0, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=255, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=PWM_Servo, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Servo, CY_INSTANCE_SHORT_NAME=PWM_Servo, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_Servo, )
...
module top ;
	...
	wire [0:0] tmpOE__Pin_Limit_1_net;
	wire [0:0] tmpIO_0__Pin_Limit_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Limit_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Limit_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Limit_1
		 (.oe(tmpOE__Pin_Limit_1_net),
		  .y({1'b0}),
		  .fb({Net_200}),
		  .io({tmpIO_0__Pin_Limit_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Limit_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Limit_1_net[0:0]}),
		  .annotation({Net_48}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Limit_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Limit_2_net;
	wire [0:0] tmpIO_0__Pin_Limit_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Limit_2_net;
	electrical [0:0] tmpSIOVREF__Pin_Limit_2_net;

	cy_psoc3_pins_v1_10
		#(.id("068bddb1-817a-434f-8762-cd4b531b6db9"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Limit_2
		 (.oe(tmpOE__Pin_Limit_2_net),
		  .y({1'b0}),
		  .fb({Net_223}),
		  .io({tmpIO_0__Pin_Limit_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Limit_2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Limit_2_net[0:0]}),
		  .annotation({Net_20}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Limit_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_0 PWM_Motor (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Pin_Direction_net;
	wire [0:0] tmpFB_0__Pin_Direction_net;
	wire [0:0] tmpIO_0__Pin_Direction_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Direction_net;
	electrical [0:0] tmpSIOVREF__Pin_Direction_net;

	cy_psoc3_pins_v1_10
		#(.id("28ebc34a-5878-4de6-9b93-e2c9ed344863"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Direction
		 (.oe(tmpOE__Pin_Direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Direction_net[0:0]}),
		  .io({tmpIO_0__Pin_Direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Direction_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SLP_net;
	wire [0:0] tmpFB_0__SLP_net;
	wire [0:0] tmpIO_0__SLP_net;
	wire [0:0] tmpINTERRUPT_0__SLP_net;
	electrical [0:0] tmpSIOVREF__SLP_net;

	cy_psoc3_pins_v1_10
		#(.id("c1a71756-15fd-4711-83ad-c4e1d4e1cccf"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SLP
		 (.oe(tmpOE__SLP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SLP_net[0:0]}),
		  .io({tmpIO_0__SLP_net[0:0]}),
		  .siovref(tmpSIOVREF__SLP_net),
		  .interrupt({tmpINTERRUPT_0__SLP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SLP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    QuadDec_v3_0_2 QuadDec (
        .quad_A(Net_139),
        .quad_B(Net_140),
        .index(Net_706),
        .clock(Net_142),
	...
	cy_psoc3_pins_v1_10
		#(.id("25b04494-a57f-496e-aea7-3fa1bf9424cf"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("69dbbfed-7e82-43d0-aea3-4a98e23e044b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Spare1_net;
	wire [0:0] tmpFB_0__Spare1_net;
	wire [0:0] tmpIO_0__Spare1_net;
	wire [0:0] tmpINTERRUPT_0__Spare1_net;
	electrical [0:0] tmpSIOVREF__Spare1_net;

	cy_psoc3_pins_v1_10
		#(.id("7a801abf-7478-41b1-9f25-a3cc9c5bd216"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Spare1
		 (.oe(tmpOE__Spare1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Spare1_net[0:0]}),
		  .io({tmpIO_0__Spare1_net[0:0]}),
		  .siovref(tmpSIOVREF__Spare1_net),
		  .interrupt({tmpINTERRUPT_0__Spare1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Spare1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Spare4_net;
	wire [0:0] tmpFB_0__Spare4_net;
	wire [0:0] tmpIO_0__Spare4_net;
	wire [0:0] tmpINTERRUPT_0__Spare4_net;
	electrical [0:0] tmpSIOVREF__Spare4_net;

	cy_psoc3_pins_v1_10
		#(.id("283096ce-e9f2-48b4-97f3-91ccafb1b3c5"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Spare4
		 (.oe(tmpOE__Spare4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Spare4_net[0:0]}),
		  .io({tmpIO_0__Spare4_net[0:0]}),
		  .siovref(tmpSIOVREF__Spare4_net),
		  .interrupt({tmpINTERRUPT_0__Spare4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Spare4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyStatusReg_v1_90 Status_Reg_Switches (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_304),
        .status_bus(Net_966[1:0]));
    defparam Status_Reg_Switches.Bit0Mode = 0;
    defparam Status_Reg_Switches.Bit1Mode = 0;
    defparam Status_Reg_Switches.Bit2Mode = 0;
    defparam Status_Reg_Switches.Bit3Mode = 0;
    defparam Status_Reg_Switches.Bit4Mode = 0;
    defparam Status_Reg_Switches.Bit5Mode = 0;
    defparam Status_Reg_Switches.Bit6Mode = 0;
    defparam Status_Reg_Switches.Bit7Mode = 0;
    defparam Status_Reg_Switches.BusDisplay = 1;
    defparam Status_Reg_Switches.Interrupt = 1;
    defparam Status_Reg_Switches.MaskValue = 3;
    defparam Status_Reg_Switches.NumInputs = 2;


    assign Net_1096[0] = ~Net_200;
	...
	cy_psoc3_pins_v1_10
		#(.id("99a54865-2e0c-4e8b-8979-f2d08319ddba"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f4aa77f2-7f08-4cf0-a8ef-c2eec1eb35ad"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Dip_4_net;
	wire [0:0] tmpIO_0__Dip_4_net;
	wire [0:0] tmpINTERRUPT_0__Dip_4_net;
	electrical [0:0] tmpSIOVREF__Dip_4_net;

	cy_psoc3_pins_v1_10
		#(.id("cc6bc75b-64eb-421a-ab21-42a67353811a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Dip_4
		 (.oe(tmpOE__Dip_4_net),
		  .y({1'b0}),
		  .fb({Net_525}),
		  .io({tmpIO_0__Dip_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Dip_4_net),
		  .interrupt({tmpINTERRUPT_0__Dip_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dip_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyStatusReg_v1_90 Can_addr (
        .status_0(Net_525),
        .status_1(Net_526),
        .status_2(Net_527),
        .status_3(1'b0),
        ...
        .intr(Net_534),
        .status_bus(8'b0));
    defparam Can_addr.Bit0Mode = 0;
    defparam Can_addr.Bit1Mode = 0;
    defparam Can_addr.Bit2Mode = 0;
    defparam Can_addr.Bit3Mode = 0;
    defparam Can_addr.Bit4Mode = 0;
    defparam Can_addr.Bit5Mode = 0;
    defparam Can_addr.Bit6Mode = 0;
    defparam Can_addr.Bit7Mode = 0;
    defparam Can_addr.BusDisplay = 0;
    defparam Can_addr.Interrupt = 0;
    defparam Can_addr.MaskValue = 0;
    defparam Can_addr.NumInputs = 3;
	...
	cy_psoc3_pins_v1_10
		#(.id("9841dd34-43ec-4df8-9469-e9b68a40d741"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5b07726f-35a2-4125-a8f1-1e99e4166073"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Spare5_net;
	wire [0:0] tmpFB_0__Spare5_net;
	wire [0:0] tmpIO_0__Spare5_net;
	wire [0:0] tmpINTERRUPT_0__Spare5_net;
	electrical [0:0] tmpSIOVREF__Spare5_net;

	cy_psoc3_pins_v1_10
		#(.id("e17ba827-c9dc-462a-be9b-0e0cdb6a9036"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Spare5
		 (.oe(tmpOE__Spare5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Spare5_net[0:0]}),
		  .io({tmpIO_0__Spare5_net[0:0]}),
		  .siovref(tmpSIOVREF__Spare5_net),
		  .interrupt({tmpINTERRUPT_0__Spare5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Spare5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Spare6_net;
	wire [0:0] tmpFB_0__Spare6_net;
	wire [0:0] tmpIO_0__Spare6_net;
	wire [0:0] tmpINTERRUPT_0__Spare6_net;
	electrical [0:0] tmpSIOVREF__Spare6_net;

	cy_psoc3_pins_v1_10
		#(.id("b6e0625e-c05a-4fe1-9c40-482b87196bc9"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Spare6
		 (.oe(tmpOE__Spare6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Spare6_net[0:0]}),
		  .io({tmpIO_0__Spare6_net[0:0]}),
		  .siovref(tmpSIOVREF__Spare6_net),
		  .interrupt({tmpINTERRUPT_0__Spare6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Spare6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5e7847a7-4d2e-4262-9527-8af7ff6cb23a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("236538ba-5d50-4140-9353-fb0c2202e8e6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9a9fade5-9d3e-42a7-80f2-fa5d0c6f7de5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Test_LED_net;
	wire [0:0] tmpFB_0__Test_LED_net;
	wire [0:0] tmpIO_0__Test_LED_net;
	wire [0:0] tmpINTERRUPT_0__Test_LED_net;
	electrical [0:0] tmpSIOVREF__Test_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("4427cead-47ee-4ed3-ad16-0ab643204edc"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Test_LED
		 (.oe(tmpOE__Test_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Test_LED_net[0:0]}),
		  .io({tmpIO_0__Test_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Test_LED_net),
		  .interrupt({tmpINTERRUPT_0__Test_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Test_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Laser_net;
	wire [0:0] tmpFB_0__Laser_net;
	wire [0:0] tmpIO_0__Laser_net;
	wire [0:0] tmpINTERRUPT_0__Laser_net;
	electrical [0:0] tmpSIOVREF__Laser_net;

	cy_psoc3_pins_v1_10
		#(.id("f350dccf-570a-47d7-9fe0-79002284ad5a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Laser
		 (.oe(tmpOE__Laser_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Laser_net[0:0]}),
		  .io({tmpIO_0__Laser_net[0:0]}),
		  .siovref(tmpSIOVREF__Laser_net),
		  .interrupt({tmpINTERRUPT_0__Laser_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Laser_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1fe893e1-05c5-4676-bf82-fff018864082"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e13f97ae-2993-4d94-911a-5897373c2d8b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_Encoder_Z_net;
	wire [0:0] tmpIO_0__Pin_Encoder_Z_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Encoder_Z_net;
	electrical [0:0] tmpSIOVREF__Pin_Encoder_Z_net;

	cy_psoc3_pins_v1_10
		#(.id("15830d94-5781-4997-8746-10cefae5bafc"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Encoder_Z
		 (.oe(tmpOE__Pin_Encoder_Z_net),
		  .y({1'b0}),
		  .fb({Net_706}),
		  .io({tmpIO_0__Pin_Encoder_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Encoder_Z_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Encoder_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Encoder_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
