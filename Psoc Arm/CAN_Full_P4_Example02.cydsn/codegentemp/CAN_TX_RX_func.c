...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgswitchStatus
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgswitchStatus(void) 
    {
        /* `#START MESSAGE_switchStatus_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_switchStatus_CALLBACK
            CAN_ReceiveMsg_switchStatus_Callback();
        #endif /* CAN_RECEIVE_MSG_switchStatus_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_ReceiveMsgADCdata
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgADCdata(void) 
    {
        /* `#START MESSAGE_ADCdata_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_ADCdata_CALLBACK
            CAN_ReceiveMsg_ADCdata_Callback();
        #endif /* CAN_RECEIVE_MSG_ADCdata_CALLBACK */
