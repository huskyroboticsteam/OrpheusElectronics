...
#define Can_addr_sts_sts_reg__MASK_ST_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK3
#define Can_addr_sts_sts_reg__PER_ST_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK3
#define Can_addr_sts_sts_reg__STATUS_AUX_CTL_REG CYREG_UDB_W8_ACTL3
#define Can_addr_sts_sts_reg__STATUS_CNT_REG CYREG_UDB_CAT16_CTL_ST3
#define Can_addr_sts_sts_reg__STATUS_CONTROL_REG CYREG_UDB_CAT16_CTL_ST3
...
#define Status_Reg_Switches_sts_intr_sts_reg__MASK_ST_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK5
#define Status_Reg_Switches_sts_intr_sts_reg__PER_ST_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK5
#define Status_Reg_Switches_sts_intr_sts_reg__STATUS_AUX_CTL_REG CYREG_UDB_W8_ACTL5
#define Status_Reg_Switches_sts_intr_sts_reg__STATUS_CNT_REG CYREG_UDB_CAT16_CTL_ST5
#define Status_Reg_Switches_sts_intr_sts_reg__STATUS_CONTROL_REG CYREG_UDB_CAT16_CTL_ST5
