            ...
            if ((CAN_BUF_SR_REG & shift) != 0u)
            {
                if ((CAN_RX_CMD_REG(mailboxNumber) & CAN_RX_INT_ENABLE_MASK) != 0u)
                {
                    if ((CAN_RX_MAILBOX_TYPE & shift) != 0u)
                    {
                        ...
                        {
                            case 0u : CAN_ReceiveMsgToBaseRotation_1();
                            break;
                            case 1u : CAN_ReceiveMsgToShoulder_1();
                            break;
                            case 2u : CAN_ReceiveMsgToElbow_1();
                            break;
                            case 3u : CAN_ReceiveMsgForearmRot_1();
                            break;
                            case 4u : CAN_ReceiveMsgToDiffWrist_1();
                            break;
                            case 5u : CAN_ReceiveMsgToDiffWrist2_1();
                            break;
                            case 6u : CAN_ReceiveMsgToHand_1();
                            break;
                            case 7u : CAN_ReceiveMsgToBaseRotation_0();
                            break;
                            case 8u : CAN_ReceiveMsgToShoulder_0();
                            break;
                            case 9u : CAN_ReceiveMsgToElbow_0();
                            break;
                            case 10u : CAN_ReceiveMsgForearmRot_0();
                            break;
                            case 11u : CAN_ReceiveMsgToDiffWrist_0();
                            break;
                            case 12u : CAN_ReceiveMsgToDiffWrist2_0();
                            break;
                            case 13u : CAN_ReceiveMsgToHand_0();
                            break;
                            default:
                            break;
                        }
